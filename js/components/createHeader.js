  ...
  if ((profileIcons, postDetails)) {
    ...
    if (userName) {
      navLink = `
            ...
            `;
      postDetail = `
                <a href="/create-post.html" class="p-8 font-regular ${
                  pathname === '/create-post.html' ? '' : ''
                }"><h1 class="">Hi ${userName}, What are you thinking about today?</h1><p>Create a new post</p></a>
            `;
    }
